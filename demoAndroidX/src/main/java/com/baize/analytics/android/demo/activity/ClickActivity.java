...
import com.baize.analytics.android.demo.databinding.ActivityClickBinding;
import com.baize.analytics.android.demo.entity.BindingEntity;
...
public class ClickActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void type9() {
        ...
        BaizeAPI.sharedInstance().ignoreView(textView);

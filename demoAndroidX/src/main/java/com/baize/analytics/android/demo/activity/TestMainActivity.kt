...
import com.baize.analytics.android.demo.PopupMenuActivity
import com.baize.analytics.android.demo.R
import com.baize.analytics.android.demo.R.id.recyclerView
import com.baize.analytics.android.demo.custom.HorizonRecyclerDivider
...
class TestMainActivity : AppCompatActivity() {
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        BaizeUtils.handleSchemeUrl(this, intent)
    }
}
...
public class BaizeUtilsTest {
    private static final String TAG = "BaizeUtilsTest";
    @Rule
    ...
    public void getIMEITest() {
        String imei = BaizeUtils.getIMEI(context);
    ...
    public void isFirstChannelEvent() {
        ...
        boolean isFirst = BaizeUtils.isFirstChannelEvent(context, "hello");
        assertTrue(isFirst);
        isFirst = BaizeUtils.isFirstChannelEvent(context, "hello");
        assertFalse(isFirst);
    }
}

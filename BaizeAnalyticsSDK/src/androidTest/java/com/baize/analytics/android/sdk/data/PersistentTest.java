...
import com.baize.analytics.android.sdk.data.persistent.PersistentIdentity;
...
public class PersistentTest {
    ...
    public void persistentDataTest() {
        SharedPreferences sharedPreferences = context.getSharedPreferences("BaizeAPI", Context.MODE_PRIVATE);
        ...
        sharedPreferences.edit().clear().apply();
        {
            ...
            assertThat(dataStr, allOf(notNullValue(), equalTo(BaizeUtils.getAndroidID(context))));

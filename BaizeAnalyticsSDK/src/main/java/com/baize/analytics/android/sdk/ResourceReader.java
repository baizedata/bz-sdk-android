...
public abstract class ResourceReader implements ResourceIds {
    ...
    private static void readClassIds(Class<?> platformIdClass, String namespace,
        ...
        try {
            ...
            BzLog.i(TAG, "Can't read built-in id names from " + platformIdClass.getName(), e);
        }
    }
    ...
    protected void initialize() {
        ...
        try {
            ...
            BzLog.i(TAG, "Can't load names for Android view ids from '" + localClassName
            ...
            BzLog.i(TAG,
                    "You may be missing a Resources class for your package due to your proguard configuration, "
                            ...
                            + " to explicitly point the Baize library to the appropriate library for your"
                            + " resources class:\n\n"
                            + "<meta-data android:name=\"com.baize.analytics.android.ResourcePackageName\""

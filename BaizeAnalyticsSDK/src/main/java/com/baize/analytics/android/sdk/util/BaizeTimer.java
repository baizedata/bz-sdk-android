...
import com.baize.analytics.android.sdk.ThreadNameConstants;
...
public class BaizeTimer {
    private static BaizeTimer instance;
    private ScheduledExecutorService mScheduledExecutorService;

    private BaizeTimer() {
    }

    public static BaizeTimer getInstance() {
        if (instance == null) {
            instance = new BaizeTimer();
        }
        return instance;
    }

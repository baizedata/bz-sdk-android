...
import com.baize.analytics.android.sdk.AopConstants;
import com.baize.analytics.android.sdk.BaizeAPI;
import com.baize.analytics.android.sdk.Pathfinder;
import com.baize.analytics.android.sdk.R;
import com.baize.analytics.android.sdk.BzLog;
import com.baize.analytics.android.sdk.ScreenAutoTracker;
import com.baize.analytics.android.sdk.BaizeFragmentTitle;
import com.baize.analytics.android.sdk.visual.ViewNode;
...
public class AopUtil {
        ...
        try {
            if (context != null) {
                if (context instanceof Activity) {
                    ...
                    if (view != null) {
                        Object object = view.getTag(R.id.baize_tag_view_activity);
                        if (object != null) {
    ...
    public static void getScreenNameAndTitleFromFragment(JSONObject properties, Object fragment, Activity activity) {
        try {
            ...
            if (TextUtils.isEmpty(title) && fragment.getClass().isAnnotationPresent(BaizeFragmentTitle.class)) {
    ...
    public static String getViewId(View view) {
        ...
        try {
            idString = (String) view.getTag(R.id.baize_tag_view_id);
    ...
    public static boolean isViewIgnored(Class viewType) {
        try {
            ...
            List<Class> mIgnoredViewTypeList = BaizeAPI.sharedInstance().getIgnoredViewTypeList();
    ...
    public static boolean isViewIgnored(View view) {
        try {
            ...
            //View 被忽略
            return "1".equals(view.getTag(R.id.baize_tag_view_ignored));
        ...
        try {
            if (activity != null) {
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= 11) {
                        String toolbarTitle = BaizeUtils.getToolbarTitle(activity);
    ...
    public static Object getFragmentFromView(View view) {
        try {
            if (view != null) {
                String fragmentName = (String) view.getTag(R.id.baize_tag_view_fragment_name);
                String fragmentName2 = (String) view.getTag(R.id.baize_tag_view_fragment_name2);
...
//
//        try {
//            if (!BaizeAPI.sharedInstance().isHeatMapEnabled() && (!BaizeAPI.sharedInstance().isVisualizedAutoTrackEnabled())) {
//                return;
//            }
//            if (activity != null) {
//                if (!BaizeAPI.sharedInstance().isHeatMapActivity(activity.getClass()) && !BaizeAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass())) {
//                    return;
//                }
//            }
//            if (view == null) {
